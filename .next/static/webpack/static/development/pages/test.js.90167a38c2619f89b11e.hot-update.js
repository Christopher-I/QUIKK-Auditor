...
function loadWeb3() {
  ...
  if (typeof web3Injected !== 'undefined') {
    ...
    web3 = new web3__WEBPACK_IMPORTED_MODULE_9___default.a(web3Injected.currentProvider);
  } else {
    console.log("did not see web3 injected!");
    web3 = new web3__WEBPACK_IMPORTED_MODULE_9___default.a(new web3__WEBPACK_IMPORTED_MODULE_9___default.a.providers.HttpProvider("http://localhost:8545")); //console.debug(web3.eth.accounts);
  }
}
...
//# sourceMappingURL=test.js.90167a38c2619f89b11e.hot-update.js.map