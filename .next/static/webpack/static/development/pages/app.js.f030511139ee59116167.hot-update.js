...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(landingPage, [{
    ...
    value: function selectCompiler(compiler) {
      console.log("compiler is " + compiler); // this.setState({
    ...
    value: function storeContractCodeToState(contractCode) {
      console.log("contract code is " + contractCode); // this.setState({
...
//# sourceMappingURL=app.js.f030511139ee59116167.hot-update.js.map