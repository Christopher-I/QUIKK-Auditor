      ...
      if (_this.state.currentCompiler) {
        ...
        BrowserSolc.loadVersion.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this))(_this.state.currentCompiler, function (compiler) {
          ...
          if (result.errors) {
            ...
            self.setState({
              gasEstimate: results.contracts[':migrations'].gasEstimates.creation,
              percent: 100,
              successMessage: "Audit Complete!"
            });
          }

          console.log(results.contracts[':migrations'].gasEstimates.creation);
        });
      } else {
        _this.setState({
...
//# sourceMappingURL=app.js.409290d3fbba96b7617f.hot-update.js.map